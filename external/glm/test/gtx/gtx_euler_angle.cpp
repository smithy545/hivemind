...
namespace test_eulerAngleXY {
    int test() {
        ...
        glm::vec4 const V1 =
                (glm::rotate(glm::mat4(1.0f), AngleX, axisX) * glm::rotate(glm::mat4(1.0f), AngleY, axisY)) * V;
...
namespace test_eulerAngleYX {
    int test() {
        ...
        glm::vec4 const V1 =
                (glm::rotate(glm::mat4(1.0f), AngleY, axisY) * glm::rotate(glm::mat4(1.0f), AngleX, axisX)) * V;
...
namespace test_eulerAngleXZ {
    int test() {
        ...
        glm::vec4 const V1 =
                (glm::rotate(glm::mat4(1.0f), AngleX, axisX) * glm::rotate(glm::mat4(1.0f), AngleZ, axisZ)) * V;
...
namespace test_eulerAngleZX {
    int test() {
        ...
        glm::vec4 const V1 =
                (glm::rotate(glm::mat4(1.0f), AngleZ, axisZ) * glm::rotate(glm::mat4(1.0f), AngleX, axisX)) * V;
...
namespace test_eulerAngleYZ {
    int test() {
        ...
        glm::vec4 const V1 =
                (glm::rotate(glm::mat4(1.0f), AngleY, axisY) * glm::rotate(glm::mat4(1.0f), AngleZ, axisZ)) * V;
...
namespace test_eulerAngleZY {
    int test() {
        ...
        glm::vec4 const V1 =
                (glm::rotate(glm::mat4(1.0f), AngleZ, axisZ) * glm::rotate(glm::mat4(1.0f), AngleY, axisY)) * V;
...
namespace test_eulerAngleYXZ {
    int test() {
        ...
        glm::fmat4 rotationInvertedY =
                glm::eulerAngleY(-1.f * first) * glm::eulerAngleX(second) * glm::eulerAngleZ(third);
...
namespace test_extractsEulerAngles {
    ...
    int test(RotationFunc rotationFunc, TestExtractionFunc testExtractionFunc) {
        ...
        for (size_t i = 0, size = testEulerAngles.size(); i < size; ++i) {
            ...
            glm::mat4 const extractedRotation = rotationFunc(extractedEulerAngles.x, extractedEulerAngles.y,
                                                             extractedEulerAngles.z);
