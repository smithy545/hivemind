...
namespace glm {
    ...
    template<length_t L, typename T, qualifier Q>
    GLM_FUNC_QUALIFIER vec <L, T, Q> convertLinearToSRGB(vec < L, T, Q >
    const& ColorLinear) {
    return
...
template<>
GLM_FUNC_QUALIFIER vec<3, float, lowp> convertLinearToSRGB(vec < 3, float, lowp >
const& ColorLinear)
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec <L, T, Q> convertSRGBToLinear(vec < L, T, Q >
const& ColorSRGB)
{
return
