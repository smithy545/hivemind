...
namespace glm {
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_QUALIFIER T perlin(vec < 2, T, Q >
    const& Position) {
    vec<4, T, Q> Pi =
            glm::floor(vec<4, T, Q>(Position.x, Position.y, Position.x, Position.y)) + vec<4, T, Q>(0.0, 0.0, 1.0, 1.0);
    vec<4, T, Q> Pf =
            glm::fract(vec<4, T, Q>(Position.x, Position.y, Position.x, Position.y)) - vec<4, T, Q>(0.0, 0.0, 1.0, 1.0);
...
// Classic Perlin noise
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T perlin(vec < 3, T, Q >
const& Position)
{
...
// Classic Perlin noise
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T perlin(vec < 4, T, Q >
const& Position)
{
...
vec<4, T, Q> n_0w = mix(vec<4, T, Q>(n0000, n1000, n0100, n1100), vec<4, T, Q>(n0001, n1001, n0101, n1101),
                        fade_xyzw.w);
vec<4, T, Q> n_1w = mix(vec<4, T, Q>(n0010, n1010, n0110, n1110), vec<4, T, Q>(n0011, n1011, n0111, n1111),
                        fade_xyzw.w);
...
{
vec<4, T, Q> Pi =
        floor(vec<4, T, Q>(Position.x, Position.y, Position.x, Position.y)) + vec<4, T, Q>(0.0, 0.0, 1.0, 1.0);
vec<4, T, Q> Pf =
        fract(vec<4, T, Q>(Position.x, Position.y, Position.x, Position.y)) - vec<4, T, Q>(0.0, 0.0, 1.0, 1.0);
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T simplex(vec < 3, T, Q >
const& v)
{
...
vec<4, T, Q> a0 = vec<4, T, Q>(b0.x, b0.z, b0.y, b0.w) +
                  vec<4, T, Q>(s0.x, s0.z, s0.y, s0.w) * vec<4, T, Q>(sh.x, sh.x, sh.y, sh.y);
vec<4, T, Q> a1 = vec<4, T, Q>(b1.x, b1.z, b1.y, b1.w) +
                  vec<4, T, Q>(s1.x, s1.z, s1.y, s1.w) * vec<4, T, Q>(sh.z, sh.z, sh.w, sh.w);
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T simplex(vec < 4, T, Q >
const& v)
{
vec<4, T, Q> const C(
