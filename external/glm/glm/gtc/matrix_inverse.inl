...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER mat<3, 3, T, Q> affineInverse(mat < 3, 3, T, Q >
    const& m) {
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q> affineInverse(mat < 4, 4, T, Q >
const& m)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<2, 2, T, Q> inverseTranspose(mat < 2, 2, T, Q >
const& m)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<3, 3, T, Q> inverseTranspose(mat < 3, 3, T, Q >
const& m)
{
T Determinant =
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q> inverseTranspose(mat < 4, 4, T, Q >
const& m)
{
