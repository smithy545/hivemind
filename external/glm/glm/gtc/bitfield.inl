...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER genIUType mask(genIUType Bits) {
        ...
        return Bits >= sizeof(genIUType) * 8 ? ~static_cast<genIUType>(0) : (static_cast<genIUType>(1) << Bits) -
                                                                            static_cast<genIUType>(1);
    }

    template<length_t L, typename T, qualifier Q>
    GLM_FUNC_QUALIFIER vec <L, T, Q> mask(vec < L, T, Q >
    const& v) {
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec <L, T, Q> bitfieldRotateRight(vec < L, T, Q >
const& In,
int Shift
)
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec <L, T, Q> bitfieldRotateLeft(vec < L, T, Q >
const& In,
int Shift
)
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec <L, T, Q> bitfieldFillOne(vec < L, T, Q >
const& Value,
int FirstBit,
int BitCount
)
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec <L, T, Q> bitfieldFillZero(vec < L, T, Q >
const& Value,
int FirstBit,
int BitCount
)
