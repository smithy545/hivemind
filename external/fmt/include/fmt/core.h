...
// warnings.
            template<typename T>
            FMT_CONSTEXPR T const_check(T value) { return value; }
 ...
 */
        ...
        public:
            using char_type FMT_DEPRECATED_ALIAS =
            Char;
...
// char8_t is deprecated; use char instead.
        using char8_t FMT_DEPRECATED_ALIAS =
        internal::char8_type;
#endif
...
// A type-erased reference to an std::locale to avoid heavy <locale> include.
            ...
            public:
                ...
                const T &push(const Arg &arg) {
                    auto node = std::unique_ptr<typed_node < T>>
